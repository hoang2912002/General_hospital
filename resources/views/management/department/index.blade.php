                                    ...
                                    <div class="card-header  d-flex justify-content-between pb-0">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto d-flex">
                                                <a href="{{ route('department.create') }}" class="btn bg-gradient-primary btn-sm mb-0 "   target="">+&nbsp; Thêm</a>&nbsp;
                                                <button type="button" class="btn btn-outline-primary btn-sm mb-0"data-bs-toggle="modal" data-bs-target="#import">Nhập Excel</button>&nbsp;
                                                <div class="modal fade" id="import" tabindex="-1" style="display: none;"aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{route('user.import')}}" method="POST" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit"class="btn bg-gradient-primary btn-sm" name="import_excel">Cập nhật</button>
                                                                </div>
                                                            </form>
                                                    ...
                                                    <form action="{{route('user.export')}}" method="POST"  class="ms-auto my-auto" >
                                                        @csrf
                                                        @method('POST')
                                                        <button class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"data-type="csv" type="submit" name="export_excel">Xuất Excel</button>
                                                    </form>
...
@push('js')
    <script>
        ...
        renderTable("{!! route('department.index') !!}", columns);
    </script>
@endpush
