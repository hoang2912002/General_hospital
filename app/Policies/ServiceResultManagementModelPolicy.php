...
class ServiceResultManagementModelPolicy
{
    /**
    ...
    {
        if(in_array('service_result_management.index',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('service_result_management.create',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('service_result_management.update',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('service_result_management.destroy',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
