...
class PatientModelPolicy
{
    ...
    {
        if(in_array('patient.index',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('patient.create',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('patient.update',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
    ...
    {
        if(in_array('patient.destroy',$loginModel->User->getPermision())){
            return true;
        }
        return false;
    }
