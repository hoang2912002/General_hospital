                                    ...
                                    <div class="card-header  d-flex justify-content-between pb-0">
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto d-flex">
                                                ...
                                                <div class="modal fade" id="import" tabindex="-1" style="display: none;"aria-hidden="true">
                                                    <div class="modal-dialog mt-lg-10">
                                                        <div class="modal-content">
                                                            ...
                                                            {{-- import data user --}}
                                                            <form action="{{route('medical_equipment.import')}}" method="POST" enctype="multipart/form-data" >
                                                                @csrf
                                                                @method('POST')
                                                ...
                                                <form action="{{route('medical_equipment.export')}}" method="POST"  class="ms-auto my-auto" >
                                                    @csrf
                                                    @method('POST')
