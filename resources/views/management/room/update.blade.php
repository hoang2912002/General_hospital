                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <select class="form-control" name="department_id" id="choices-department" >
                                                ...
                                                @foreach ($department as $item)
                                                    <option value="{{ $item->id }}" @if ($item->id == $roomModel->department_id)@selected(true)@endif>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('name')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <select class="form-control" name="file_type" id="choices-role" >
                                                ...
                                                <option value="pdf" @if ($roomModel->file_type == 'pdf')@selected(true)@endif>PDF</option>
                                                <option value="excel"@if ($roomModel->file_type == 'excel')@selected(true)@endif>Excel</option>
