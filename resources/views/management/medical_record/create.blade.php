            ...
            <div class="multisteps-form mb-8">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        ...
                        <form class="multisteps-form__form mb-8 " action="{{ route('medical_record.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                                data-animation="FadeIn">
                                <h5 class="font-weight-bolder mb-0">{{ $userModel->name() }}</h5>
