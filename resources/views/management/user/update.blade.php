                                    ...
                                    <div class="div-infor-dentist" style="display:none">
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                ...
                                                <textarea class="form-control" id="description" rows="10" name="description">{{ $userModel->doctor->description ?? old('description') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                ...
                                                <div class=" d-flex justify-content-center pip" id="avatar">
                                                    <img style="width: 200px"  src="{{ !empty($userModel->doctor->image) ? asset($userModel->doctor->image) : 'https://upload.wikimedia.org/wikipedia/commons/b/b1/Loading_icon.gif?20151024034921' }} "title="" id="loading_before"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
