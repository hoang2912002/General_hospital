            ...
            <div class="multisteps-form mb-5">
                            ...
                            <div class="card-body">
                                <div class="multisteps-form__progress">
                                    <button class="multisteps-form__progress-btn js-active" type="button"
                                        title="User Info">
                                        <span>Cập nhật thông tin {{ $name_page['total'] }}</span>
                                    </button>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <form class="multisteps-form__form mb-8" action="{{ route('department.update',$departmentModel) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="multisteps-form__content">
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <input class="multisteps-form__input form-control" type="text" placeholder="eg. Admin" name="name" value="{{ $departmentModel->name ?? old('name') }}">
                                            @error('name')
